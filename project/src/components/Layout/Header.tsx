  ...
  <div className={`${collapsed ? 'ml-20' : 'ml-64'} max-w-full w-auto px-6 py-4 flex items-center justify-between transition-all duration-300`}>
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            <button onClick={() => onNavigate && onNavigate('settings')} className="p-2 text-nee-700 hover:text-nee-700 hover:bg-nee-50 rounded-lg transition-colors" title="Settings">
